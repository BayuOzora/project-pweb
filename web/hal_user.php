...
if ($_SESSION['level'] == "user") {
  ...
  session_destroy();
}else if($_SESSION['level'] == 'petugas' || 'viewer'){
  echo "<script>
...
<body>
  ...
  <div class="site-mobile-menu site-navbar-target">
    <div class="site-mobile-menu-header">
      <div class="site-mobile-menu-close mt-3">
        <span class="icon-close2 js-menu-toggle"></span>r
      </div>
    </div>
  ...
  <div class="card" style="margin-top: 75px;margin:30px;">
    ...
    <div class="card-body">
      <a href="tambahTamu.php" class="btn btn-lg btn-success mb-3">Tambah Data  <i class="fas fa-plus"></i> </a>
